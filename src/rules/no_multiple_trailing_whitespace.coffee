...
module.exports = class NoTrailingDoubleWhitespace

    rule:
        name: 'no_multiple_trailing_whitespace'
        level: 'error'
        message: 'Line ends with multiple trailing whitespace'
        allowed_in_comments: false
        allowed_in_empty_lines: true
        description: '''
            This rule forbids multiple trailing whitespace in your code, since it is
